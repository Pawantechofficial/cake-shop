            ...
            <div className="flex flex-col mt-4 items-center md:flex-row">
              <div className="flex gap-14 items-center">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="flex text-white bg-[#FF527B] text-sm border-0 py-2 px-4 focus:outline-none hover:border hover:border-[#FF527B] hover:bg-transparent hover:text-[#ff527b] rounded-full">
                    Add to Cart
                  </button>
                </div>
              </div>
